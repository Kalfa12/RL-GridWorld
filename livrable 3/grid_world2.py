...
def run_model_free_agent(agent, env, num_episodes=5000):
    ...
    for episode in range(num_episodes):
        ...
        if (episode + 1) % 500 == 0:
            print(f"Episode {episode + 1}/{num_episodes} | Avg Reward: {np.mean(episode_rewards[-10000:]):.2f}")
...
####################################################################
# SECTION 4: MAIN EXECUTION (UPDATED)k,
####################################################################
if __name__ == "__main__":
    ...
    if choice == '1':
        ...
        run_model_free_agent(agent, env, num_episodes=500)
    elif choice == '5':
